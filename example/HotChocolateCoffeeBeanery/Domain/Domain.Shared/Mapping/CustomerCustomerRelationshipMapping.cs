    ...
    : BaseMappingRegistration<CustomerCustomerRelationship, DataEntity.CustomerCustomerRelationship>
{
    ...
    protected override NodeMap BuildMap()
    {
        ...
        map.FieldMaps.AddRange(new[]
        {
            ...
            new FieldMap { SourceAlias = A(nameof(DataEntity.CustomerCustomerRelationship.InnerCustomer)), DestinationAlias = A(nameof(DataEntity.Customer)), SourceName = nameof(DataEntity.CustomerCustomerRelationship.InnerCustomerKey),                DestinationEntity = nameof(DataEntity.CustomerCustomerRelationship), DestinationName = nameof(DataEntity.CustomerCustomerRelationship.InnerCustomerKey) },
            new FieldMap { SourceAlias = A(nameof(DataEntity.CustomerCustomerRelationship.OuterCustomer)), DestinationAlias = A(nameof(DataEntity.Customer)), SourceName = nameof(DataEntity.CustomerCustomerRelationship.OuterCustomerKey),                DestinationEntity = nameof(DataEntity.CustomerCustomerRelationship), DestinationName = nameof(DataEntity.CustomerCustomerRelationship.OuterCustomerKey) },
